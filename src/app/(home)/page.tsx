              ...
              <div className='col-lg-6 col-12 mt-lg-0 mt-5'>
                <div className='row'>
                  ...
                  <div className='col pb-5 ps-5 border-start border-primary-subtle border-4'>
                    ...
                    Récupérez votre badge pour la journée, puis prenez le temps du petit-déjeuner pour discuter un café à la
                    main.
                  </div>
                </div>
                <div className='row'>
          ...
          <div className='container'>
            <div className='row'>
              <div className='col-xl-7 col-lg-9 col-12 mx-auto text-center'>
                ...
                <p className='lead my-4'>
                  Des experts renommés dans leurs domaines partageront leurs connaissances pour vous aider à vous épanouir en
                  tant que freelance
                </p>
              </div>
            </div>
            ...
            <div className='row mt-0 gx-xl-6 gy-4'>
              <div className='col-lg-4 col-md-8 col-12 mx-auto'>
                <div className='bg-white rounded-5'>
                  ...
                  <div className='p-4'>
                    <p>
                      L’offre <b>Early bird</b> donne l’accès à un tarif préférentiel, le nombre de billets à ce tarif est
                      limité à <b>60 places</b>, les premiers arrivés sont les premiers servis !
                    </p>
                ...
                <div className='bg-white rounded-5'>
                  ...
                  <div className='p-4'>
                    <p>
                      ...
                      possible en contribuant à assurer l’équilibre économique et nous vous{' '}
                      <b>en remercions chaleureusement !</b>
                    </p>
                    <div className='text-center my-4'>
                      <button className='btn btn-primary' disabled>
                        Choisir ce billet
